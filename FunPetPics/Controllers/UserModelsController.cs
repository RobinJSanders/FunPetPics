...
namespace FunPetPics.Controllers
{
    public class UserModelsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("UserId,Email,DisplayName")] UserModel userModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("UserId,Email,DisplayName")] UserModel userModel)
        {
